...
📌 Project Overview
This project is a simulated business case based on a corporate crisis. In 2025, the company hit a record high attrition rate (83 separations). My mission was to act as a Data Detective: identify why people were leaving and track the success of the 2026 "Win-Back" mission to bring them back.
...
Data Cleaning: Handled "rubbish" data fields by standardizing status labels and calculating consistent tenure metrics.

🔍 Key Findings (The 2025 Diagnosis)
Using 18 targeted SQL queries, I identified the "Smoking Guns" behind the attrition:
...
Following my 2025 audit, stakeholders launched a mission to recover lost talent.
